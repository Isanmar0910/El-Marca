...
let valorAnterior = null;           //Se usara para guardar el valor tras pulsar +, -, *, /
let operadorAcrual = null;          // se usara cuando metamos operaciones de  +, -, *, /3
let resultadoMostrado = false;      // Para saber si el usuario ha oulsado ya el =


//Seleccionamos los elementos del DOM

const pantalla = document.getElementById("pantalla")    //Pantalla
// const botones = document.querySelectorAll(".boton")     //NodeList de botones
const botones = [...document.querySelectorAll(".boton")]; //Convierto el nodelist en array
for (let i = 0; i < botones.length; i++) {
    
    botones[i].addEventListener("click", function(){
        mostrarNumeroPantalla(botones[i].textContent)
    });
}
