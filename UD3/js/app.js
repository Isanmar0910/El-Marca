...
const cesta = [
    {nombre: "Teclado", precio: 19.99},
    {nombre: "Ratón", precio: 12.95},
    {nombre: "Auriculares", precio: 50} 
    
];

const sumaCesta = function(cesta) {
    return cesta[0].precio + cesta[1].precio + cesta[3].precio;
};  

console.log(`Total= ${sumaCesta()}`)